...
\begin{tabular}[c]{|p{0.29\textwidth}|p{0.09\textwidth}|p{0.09\textwidth}|p{0.09\textwidth}|p{0.09\textwidth}|p{0.09\textwidth}|p{0.09\textwidth}|}
	\hline
...
\begin{tabular}[c]{|p{0.14\textwidth}|p{0.14\textwidth}|p{0.10\textwidth}|p{0.15\textwidth}|p{0.10\textwidth}|p{0.10\textwidth}|p{0.10\textwidth}|} 
	\hline
...
\foreach \pages in {1,2,...,59}{% %% TODO complétion à 64 PAGES !! (59 à priori)
	% \tikz \foreach \x / \y in {1/1,2/2...,30/20} \draw (\x,\y) circle (0.25);
	\begin{tikzpicture}
		\foreach \x in {0,0.5,...,19 } %% 15 | paperwidth | textwidth
