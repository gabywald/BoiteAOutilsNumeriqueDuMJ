...
% \usepackage[top=0.10cm, bottom=0.10cm, left=0.10cm, right=0.10cm]{geometry}
% gauche, haut, droite, bas, entete, ente2txt, pied, txt2pied
\usepackage{vmargin}
\setmarginsrb{0.20cm}{0.20cm}{0.20cm}{0.20cm}{0pt}{0pt}{0pt}{0pt}
...
% \usepackage{xkeyval}
% \usepackage{graphicx}
% \usepackage{jeuxcartes/tex/JeuxCartes}
%% \usepackage{JeuxCartes} %% \usepackage{jeuxcartes/tex/JeuxCartes}
% \usepackage{babel}
...
%% \usepackage{fdsymbol} %% commented because confliect with packages 'fontspec' / 'JeuxCartes'
%% \clubsuit
%% \vardiamondsuit
%% \spadesuit
%% \varheartsuit
...
\begin{tabular}[c]{|p{0.30\textwidth}|p{0.09\textwidth}|p{0.09\textwidth}|p{0.09\textwidth}|p{0.09\textwidth}|p{0.09\textwidth}|p{0.09\textwidth}|}
	\hline
...
\begin{tabular}[c]{|p{0.25\textwidth}|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|}
...
\begin{minipage}[ht]{0.95\textwidth}
	...
	Par défaut un Talent est MOYen ; à la création un personnage a : 
	\begin{itemize}
...
%% TODO memo des tirages possibles
...
%% DONE décorations "art déco" (géométrique) / "art nouveau" (floral)
...
\foreach \pages in {1,2,...,5}{% %% TODO complétion à 64 PAGES !! (57 À PRIORI)
...
Le présent carnet conçu par \emph{Gabriel Chandesris} en 2025 pour les joueuses et joueurs rôlistes de la \emph{Ligue Ludique} (Paris).~\\ 
