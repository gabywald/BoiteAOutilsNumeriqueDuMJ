...
\def\imgNATUR{\begin{tabular}[h]{p{0.65cm}} \includegraphics[width=0.50cm]{../../../../images/SimulacreS/normal40x40/naturel.png}	\\  \end{tabular}}
\def\imgHUMAI{\begin{tabular}[h]{p{0.65cm}} \includegraphics[width=0.50cm]{../../../../images/SimulacreS/normal40x40/humain.png}	\\  \end{tabular}}
\def\imgMATER{\begin{tabular}[h]{p{0.65cm}} \includegraphics[width=0.50cm]{../../../../images/SimulacreS/normal40x40/material.png}	\\  \end{tabular}}
\def\imgVIRTU{\begin{tabular}[h]{p{0.65cm}} \includegraphics[width=0.50cm]{../../../../images/SimulacreS/normal40x40/virtuel.png}	\\  \end{tabular}}
...
\def\imgPOUVO{\begin{tabular}[h]{p{0.65cm}} \includegraphics[width=0.50cm]{../../../../images/SimulacreS/normal40x40/pouvoir.png}	\\  \end{tabular}}
...
\begin{tabular}[h]{p{6cm} p{4cm} p{4cm} p{4cm} }
	\begin{tabular}[h]{ p{5.85cm} }
		\includegraphics[width=5.5cm]{../../../../images/SimulacreS/logos/logoSimulacreSAlternative.png} \\
	\end{tabular}
		&
