...
\def\imgCORPS{\begin{tabular}[h]{p{0.65cm}}\includegraphics[width=0.50cm]{../../../../images/SimulacreS/normal40x40/corps.png}		\\ \end{tabular}}
\def\imgINSTI{\begin{tabular}[h]{p{0.65cm}}\includegraphics[width=0.50cm]{../../../../images/SimulacreS/normal40x40/instinct.png}	\\ \end{tabular}}
\def\imgCOEUR{\begin{tabular}[h]{p{0.65cm}}\includegraphics[width=0.50cm]{../../../../images/SimulacreS/normal40x40/coeur.png}		\\ \end{tabular}}
\def\imgESPRI{\begin{tabular}[h]{p{0.65cm}}\includegraphics[width=0.50cm]{../../../../images/SimulacreS/normal40x40/esprit.png}		\\ \end{tabular}}

\def\imgPERCE{\begin{tabular}[h]{p{0.65cm}}\includegraphics[width=0.50cm]{../../../../images/SimulacreS/normal40x40/perception.png}	\\ \end{tabular}}
\def\imgACTIO{\begin{tabular}[h]{p{0.65cm}}\includegraphics[width=0.50cm]{../../../../images/SimulacreS/normal40x40/action.png}		\\ \end{tabular}}
\def\imgDESIR{\begin{tabular}[h]{p{0.65cm}}\includegraphics[width=0.50cm]{../../../../images/SimulacreS/normal40x40/desir.png}		\\ \end{tabular}}
\def\imgRESIS{\begin{tabular}[h]{p{0.65cm}}\includegraphics[width=0.50cm]{../../../../images/SimulacreS/normal40x40/resistance.png}	\\ \end{tabular}}

\def\imgMINER{\begin{tabular}[h]{p{0.65cm}}\\ \includegraphics[width=0.50cm]{../../../../images/SimulacreS/normal40x40/mineral.png}		\\ \\ \end{tabular}}
\def\imgVEGET{\begin{tabular}[h]{p{0.65cm}}\\ \includegraphics[width=0.50cm]{../../../../images/SimulacreS/normal40x40/vegetal.png}		\\ \\ \end{tabular}}
\def\imgANIMA{\begin{tabular}[h]{p{0.65cm}}\\ \includegraphics[width=0.50cm]{../../../../images/SimulacreS/normal40x40/animal.png}		\\ \\ \end{tabular}}
\def\imgHUMAI{\begin{tabular}[h]{p{0.65cm}}\\ \includegraphics[width=0.50cm]{../../../../images/SimulacreS/normal40x40/humain.png}		\\ \\ \end{tabular}}
\def\imgMECAN{\begin{tabular}[h]{p{0.65cm}}\\ \includegraphics[width=0.50cm]{../../../../images/SimulacreS/normal40x40/mecanique.png}	\\ \\ \end{tabular}}
\def\imgNEANT{\begin{tabular}[h]{p{0.65cm}}\\ \includegraphics[width=0.50cm]{../../../../images/SimulacreS/normal40x40/neant.png}		\\ \\ \end{tabular}}

\def\imgPUISS{\begin{tabular}[h]{p{0.65cm}}\\ \includegraphics[width=0.50cm]{../../../../images/SimulacreS/normal40x40/puissance.png}	\\ \\ \end{tabular}}
\def\imgRAPID{\begin{tabular}[h]{p{0.65cm}}\\ \includegraphics[width=0.50cm]{../../../../images/SimulacreS/normal40x40/rapidite.png}	\\ \\ \end{tabular}}
\def\imgPRECI{\begin{tabular}[h]{p{0.65cm}}\\ \includegraphics[width=0.50cm]{../../../../images/SimulacreS/normal40x40/precision.png}	\\ \\ \end{tabular}}
...
\begin{tabular}[h]{p{4cm} p{10cm} p{4cm}}
	...
	\begin{tabular}[h]{ p{9.5cm} }
		\includegraphics[width=9cm]{../../../../images/SimulacreS/logos/logoSimulacreS01.png} \\
	\end{tabular}
		&
	\begin{tabular}[h]{ p{2.0cm} p{2.0cm} }
		\emph{ 		 }				&	\footnotesize{R{\`e}gles de Campagne}	\\
									&											\\
									&											\\
									&											\\
		\emph{Univers : } \newline	&	\emph{ 		 }							\\
...
\multicolumn{2}{ p{6.0cm} }{ 
	...
	\begin{tabular}[h]{|p{0.75cm}|p{3.0cm}|p{0.25cm}|p{0.50cm}|}
		\hline
		\imgPERCE & PERCEPTION & \begin{tabular}[c]{|p{0.20cm}|}
		 \\ \hline \\ \hline \\
		\end{tabular} & --- \\
		\hline
		\imgACTIO & ACTION & \begin{tabular}[c]{|p{0.20cm}|}
		 \\ \hline \\ \hline \\
		\end{tabular} & --- \\
		\hline
		\imgDESIR & DESIR & \begin{tabular}[c]{|p{0.20cm}|}
		 \\ \hline \\ \hline \\
		\end{tabular} & --- \\
		\hline
		\imgRESIS & RESISTANCE & \begin{tabular}[c]{|p{0.20cm}|}
		 \\ \hline \\ \hline \\
		\end{tabular} & --- \\
		\hline
	\end{tabular} }
...
\begin{tabular}[h]{|p{3.5cm}|p{0.5cm}|p{3.5cm}|p{0.5cm}|p{3.5cm}|p{0.5cm}|p{3.5cm}|p{0.5cm}|}
	...
	\hline
		...
		\multicolumn{2}{|p{4.0cm}|}{ {\centering \textbf{-4} } }	&
		\multicolumn{2}{|p{4.0cm}|}{ {\centering \textbf{-2} } }	&
