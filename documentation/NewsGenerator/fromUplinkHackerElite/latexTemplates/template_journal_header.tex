...
\fancyfoot[LE]{\thepage /\pageref{LastPage} \hfill
	\textbf{\magazineTitle }
\hfill \includegraphics[width=0.5cm]{img/glider/logo-glider.png} }
\fancyfoot[RO]{\includegraphics[width=0.5cm]{img/glider/logo-glider.png} \hfill
	\textbf{\magazineTitle }
...
\AddToShipoutPicture{
    \AtPageUpperLeft{1cm}{
		\put(0,0){
			...
			\includegraphics[width=\paperwidth]{img/cyberpunk/CyberPunkRedBandeauHaut.jpg}%
			\vfill
		}}}
    ...
    \AtPageLowerLeft{1cm}{\includegraphics[width=\paperwidth]{img/cyberpunk/CyberPunkRedBandeauBas.jpg}}
}
